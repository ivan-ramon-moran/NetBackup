...
public class ThreadSincronizacion extends Thread {
	...
	private ArrayList<String> ptrFicheros = SistemaOperativo.ficheros;
	...
	public void run(){
		while (bEjecutar){
			...
			for (int i = 0; i < ptrFicheros.size(); i++){
				final String strElementoActual = ptrFicheros.get(i);
				clienteMsg.enviarCadena(strElementoActual);
